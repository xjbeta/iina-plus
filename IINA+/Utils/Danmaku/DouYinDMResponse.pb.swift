...
struct Douyin_Message: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Douyin_PushFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Douyin_CommentTypeTag: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0COMMENTTYPETAGUNKNOWN\0\u{1}COMMENTTYPETAGSTAR\0")
}
...
extension Douyin_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}messagesList\0\u{1}cursor\0\u{1}fetchInterval\0\u{1}now\0\u{1}internalExt\0\u{1}fetchType\0\u{1}routeParams\0\u{1}heartbeatDuration\0\u{1}needAck\0\u{1}pushServer\0\u{1}liveCursor\0\u{1}historyNoMore\0")
...
extension Douyin_Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}method\0\u{1}payload\0\u{1}msgId\0\u{1}msgType\0\u{1}offset\0\u{1}needWrdsStore\0\u{1}wrdsVersion\0\u{1}wrdsSubKey\0")
...
extension Douyin_ChatMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}user\0\u{1}content\0\u{1}visibleToSender\0\u{1}backgroundImage\0\u{1}fullScreenTextColor\0\u{1}backgroundImageV2\0\u{1}publicAreaCommon\0\u{1}giftImage\0\u{2}\u{2}agreeMsgId\0\u{1}priorityLevel\0\u{1}landscapeAreaCommon\0\u{2}\u{2}eventTime\0\u{1}sendReview\0\u{1}fromIntercom\0\u{1}intercomHideUserCard\0\u{2}\u{2}chatBy\0\u{1}individualChatPriority\0\u{1}rtfContent\0")
...
extension Douyin_LandscapeAreaCommon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}showHead\0\u{1}showNickname\0\u{1}showFontColor\0\u{1}colorValueList\0\u{1}commentTypeTagsList\0")
...
extension Douyin_GiftMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}giftId\0\u{1}fanTicketCount\0\u{1}groupCount\0\u{1}repeatCount\0\u{1}comboCount\0\u{1}user\0\u{1}toUser\0\u{1}repeatEnd\0\u{1}textEffect\0\u{1}groupId\0\u{1}incomeTaskgifts\0\u{1}roomFanTicketCount\0\u{1}priority\0\u{1}gift\0\u{1}logId\0\u{1}sendType\0\u{1}publicAreaCommon\0\u{1}trayDisplayText\0\u{1}bannedDisplayEffects\0\u{2}\u{5}displayForSelf\0\u{1}interactGiftInfo\0\u{1}diyItemInfo\0\u{1}minAssetSetList\0\u{1}totalCount\0\u{1}clientGiftSource\0\u{2}\u{2}toUserIdsList\0\u{1}sendTime\0\u{1}forceDisplayEffects\0\u{1}traceId\0\u{1}effectDisplayTs\0")
...
extension Douyin_GiftStruct: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}image\0\u{1}describe\0\u{1}notify\0\u{1}duration\0\u{1}id\0\u{2}\u{2}forLinkmic\0\u{1}doodle\0\u{1}forFansclub\0\u{1}combo\0\u{1}type\0\u{1}diamondCount\0\u{1}isDisplayedOnPanel\0\u{1}primaryEffectId\0\u{1}giftLabelIcon\0\u{1}name\0\u{1}region\0\u{1}manual\0\u{1}forCustom\0\u{2}\u{2}icon\0\u{1}actionType\0")
...
extension Douyin_GiftIMPriority: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}queueSizesList\0\u{1}selfQueuePriority\0\u{1}priority\0")
...
extension Douyin_TextEffect: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}portrait\0\u{1}landscape\0")
...
extension Douyin_TextEffectDetail: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}text\0\u{1}textFontSize\0\u{1}background\0\u{1}start\0\u{1}duration\0\u{1}x\0\u{1}y\0\u{1}width\0\u{1}height\0\u{1}shadowDx\0\u{1}shadowDy\0\u{1}shadowRadius\0\u{1}shadowColor\0\u{1}strokeColor\0\u{1}strokeWidth\0")
...
extension Douyin_MemberMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}user\0\u{1}memberCount\0\u{1}operator\0\u{1}isSetToAdmin\0\u{1}isTopUser\0\u{1}rankScore\0\u{1}topUserNo\0\u{1}enterType\0\u{1}action\0\u{1}actionDescription\0\u{1}userId\0\u{1}effectConfig\0\u{1}popStr\0\u{1}enterEffectConfig\0\u{1}backgroundImage\0\u{1}backgroundImageV2\0\u{1}anchorDisplayText\0\u{1}publicAreaCommon\0\u{1}userEnterTipType\0\u{1}anchorEnterTipType\0")
...
extension Douyin_PublicAreaCommon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}userLabel\0\u{1}userConsumeInRoom\0\u{1}userSendGiftCntInRoom\0")
...
extension Douyin_EffectConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}icon\0\u{1}avatarPos\0\u{1}text\0\u{1}textIcon\0\u{1}stayTime\0\u{1}animAssetId\0\u{1}badge\0\u{1}flexSettingArrayList\0\u{1}textIconOverlay\0\u{1}animatedBadge\0\u{1}hasSweepLight\0\u{1}textFlexSettingArrayList\0\u{1}centerAnimAssetId\0\u{1}dynamicImage\0\u{1}extraMap\0\u{1}mp4AnimAssetId\0\u{1}priority\0\u{1}maxWaitTime\0\u{1}dressId\0\u{1}alignment\0\u{1}alignmentOffset\0")
...
extension Douyin_Text: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{1}defaultPatter\0\u{1}defaultFormat\0\u{1}piecesList\0")
...
extension Douyin_TextPiece: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}format\0\u{1}stringValue\0\u{1}userValue\0\u{1}giftValue\0\u{1}heartValue\0\u{1}patternRefValue\0\u{1}imageValue\0")
...
extension Douyin_TextPieceImage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}image\0\u{1}scalingRate\0")
...
extension Douyin_TextPiecePatternRef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{1}defaultPattern\0")
...
extension Douyin_TextPieceGift: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}giftId\0\u{1}nameRef\0")
...
extension Douyin_TextPieceUser: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}user\0\u{1}withColon\0")
...
extension Douyin_TextFormat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}color\0\u{1}bold\0\u{1}italic\0\u{1}weight\0\u{1}italicAngle\0\u{1}fontSize\0\u{1}useHeighLightColor\0\u{1}useRemoteClor\0")
...
extension Douyin_LikeMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}count\0\u{1}total\0\u{1}color\0\u{1}user\0\u{1}icon\0\u{1}doubleLikeDetail\0\u{1}displayControlInfo\0\u{1}linkmicGuestUid\0\u{1}scene\0\u{1}picoDisplayInfo\0")
...
extension Douyin_SocialMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}user\0\u{1}shareType\0\u{1}action\0\u{1}shareTarget\0\u{1}followCount\0\u{1}publicAreaCommon\0")
...
extension Douyin_PicoDisplayInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}comboSumCount\0\u{1}emoji\0\u{1}emojiIcon\0\u{1}emojiText\0")
...
extension Douyin_DoubleLikeDetail: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}doubleFlag\0\u{1}seqId\0\u{1}renewalsNum\0\u{1}triggersNum\0")
...
extension Douyin_DisplayControlInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}showText\0\u{1}showIcons\0")
...
extension Douyin_EpisodeChatMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}user\0\u{1}content\0\u{1}visibleToSende\0\u{2}\u{3}giftImage\0\u{1}agreeMsgId\0\u{1}colorValueList\0")
...
extension Douyin_MatchAgainstScoreMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}common\0\u{1}against\0\u{1}matchStatus\0\u{1}displayStatus\0")
...
extension Douyin_Against: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}leftName\0\u{1}leftLogo\0\u{1}leftGoal\0\u{2}\u{3}rightName\0\u{1}rightLogo\0\u{1}rightGoal\0\u{2}\u{3}timestamp\0\u{1}version\0\u{1}leftTeamId\0\u{1}rightTeamId\0\u{1}diffSei2absSecond\0\u{1}finalGoalStage\0\u{1}currentGoalStage\0\u{1}leftScoreAddition\0\u{1}rightScoreAddition\0\u{1}leftGoalInt\0\u{1}rightGoalInt\0")
...
extension Douyin_Common: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}method\0\u{1}msgId\0\u{1}roomId\0\u{1}createTime\0\u{1}monitor\0\u{1}isShowMsg\0\u{1}describe\0\u{2}\u{2}foldType\0\u{1}anchorFoldType\0\u{1}priorityScore\0\u{1}logId\0\u{1}msgProcessFilterK\0\u{1}msgProcessFilterV\0\u{1}user\0\u{2}\u{2}anchorFoldTypeV2\0\u{1}processAtSeiTimeMs\0\u{1}randomDispatchMs\0\u{1}isDispatch\0\u{1}channelId\0\u{1}diffSei2absSecond\0\u{1}anchorFoldDuration\0")
...
extension Douyin_User: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}shortId\0\u{1}nickName\0\u{1}gender\0\u{1}Signature\0\u{1}Level\0\u{1}Birthday\0\u{1}Telephone\0\u{1}AvatarThumb\0\u{1}AvatarMedium\0\u{1}AvatarLarge\0\u{1}Verified\0\u{1}Experience\0\u{1}city\0\u{1}Status\0\u{1}CreateTime\0\u{1}ModifyTime\0\u{1}Secret\0\u{1}ShareQrcodeUri\0\u{1}IncomeSharePercent\0\u{1}BadgeImageList\0\u{2}\u{5}SpecialId\0\u{1}AvatarBorder\0\u{1}Medal\0\u{1}RealTimeIconsList\0")
...
extension Douyin_Image: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}urlListList\0\u{1}uri\0\u{1}height\0\u{1}width\0\u{1}avgColor\0\u{1}imageType\0\u{1}openWebUrl\0\u{1}content\0\u{1}isAnimated\0\u{1}FlexSettingList\0\u{1}TextSettingList\0")
...
extension Douyin_NinePatchSetting: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}settingListList\0")
...
extension Douyin_ImageContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}fontColor\0\u{1}level\0\u{1}alternativeText\0")
...
extension Douyin_PushFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}seqId\0\u{1}logId\0\u{1}service\0\u{1}method\0\u{1}headersList\0\u{1}payloadEncoding\0\u{1}payloadType\0\u{1}payload\0")

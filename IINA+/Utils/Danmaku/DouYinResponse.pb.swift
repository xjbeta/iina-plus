...
struct DouYinResponse: Sendable {
...
extension DouYinResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}wss_push_room_id\0\u{3}wss_push_did\0\u{3}wss_push_log_id\0\u{3}wss_fetch_ms\0\u{3}wss_push_ms\0\u{3}wss_msg_type\0\u{1}pb\0\u{1}data\0\u{3}server_time\0\u{3}compress_type\0")

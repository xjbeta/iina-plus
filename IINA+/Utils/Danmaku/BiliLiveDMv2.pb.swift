...
// Source: Bili_Live_dm_v2.proto
//
// For information on using the generated types, please see the documentation:
//   https://github.com/apple/swift-protobuf/

// https://github.com/sjh8130/bili_danmaku
// https://github.com/sjh8130/bili_danmaku/blob/master/docs/Live_dm_v2_2023_03_23.proto

///https://s1.hdslb.com/bfs/static/blive/blfe-live-room/static/js/app.****.js
/// dm_v2
///[0][0]                                        
///[0][1]    mode                                root\\2
///[0][2]    size/fontsize                       root\\3
///[0][3]    color                               root\\4
///[0][4]    ctime                               root\\7
///[0][5]    dmid/rnd/danmakuRnd                 root\\9
///[0][6]                                        
///[0][7]    midHash                             root\\5
///[0][8]                                        
///[0][9]    type/danmakuType                    
///[0][10]   chatBubbleType                      root\\12\\1
///[0][11]   chatBubbleColor                     root\\12\\2
///[0][12]   dm_type                             root\\13
///[0][13]   emoticonOptions                     root\\14!
///[0][14]   voice                               root\\15
///[0][15]   emoticons/modeInfo                  root\\14!
///[0][16]   Aggregation/danmakuAggregation      root\\17
///[0][17]   chatBubbleId                        root\\12\\3
///[1]       text/content                        root\\6
///[2][0]    userInfo->  uid                     root\\20\\1
///[2][1]    userInfo->  username                root\\20\\2
///[2][2]    userInfo->  isAdmin                 root\\20\\10
///[2][3]    userInfo->  isVip                   root\\20\\5
///[2][4]    userInfo->  isSvip                  root\\20\\6
///[2][5]    userInfo->  rank                    root\\20\\7
///[2][6]    userInfo->  verify                  root\\20\\8
///[2][7]    userInfo->  usernameColor           root\\20\\3
///[3][0]    fansMedal-> level                   root\\20\\11\\1
///[3][1]    fansMedal-> label                   root\\20\\11\\2
///[3][2]    fansMedal-> anchorUsername          root\\21\\2
///[3][3]    fansMedal-> RoomID                  
///[3][4]    fansMedal-> medalColor              root\\20\\11\\4
///[3][5]    fansMedal-> special                 root\\20\\11\\3
///[3][6]    fansMedal-> iconId                  root\\20\\11\\5
///[3][7]    fansMedal-> medalColorBorder        root\\20\\11\\6
///[3][8]    fansMedal-> medalColorStart         root\\20\\11\\7
///[3][9]    fansMedal-> medalColorEnd           root\\20\\11\\8
///[3][10]   fansMedal-> guardLevel              root\\20\\11\\9
///[3][11]   fansMedal-> isLight                 root\\20\\11\\10
///[3][12]   fansMedal-> anchorId                root\\21\\1
///[4][0]    userLevel-> UL                      root\\20\\12\\1
///[4][1]    userLevel->                         
///[4][2]    userLevel-> *ULColor                root\\20\\12\\2
///[4][3]    userLevel-> rank                    root\\20\\12\\3
///[4][4]    userLevel->                         root\\20\\12\\4
///[5][0]    title   ->  old_title               root\\20\\13\\2
///[5][1]    title   ->  title                   root\\20\\13\\1
///[6]                                           
///[7]       guardLevel                          
///[8]                                           
///[9]       validation                          root\\19
///[10]                                          
///[11]                                          
///[12]                                          
///[13]                                          
///[14]      lpl                                 
///[15]                                          
///[16][0]   Wealth  ->  level                   root\\20\\15\\1
///[16][??]                                      
///[16][??]                                      
///[16][??]                                      
///[16][??]                                      
...
///11
enum BilibiliDm_Community_Service_Dm_Live_BizScene: SwiftProtobuf.Enum {
...
extension BilibiliDm_Community_Service_Dm_Live_BizScene: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [BilibiliDm_Community_Service_Dm_Live_BizScene] = [
    .none,
    .lottery,
    .survive,
    .voiceConn,
...
///13
enum BilibiliDm_Community_Service_Dm_Live_DmType: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case normal // = 0
  case emoticon // = 1
  case voice // = 2
...
extension BilibiliDm_Community_Service_Dm_Live_DmType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [BilibiliDm_Community_Service_Dm_Live_DmType] = [
    .normal,
    .emoticon,
    .voice,
  ]
...
struct BilibiliDm_Community_Service_Dm_Live_Dm {
  ...
  var emoticons: [BilibiliDm_Community_Service_Dm_Live_emots] {
  ...
  var unknown23: Data {
    get {return _storage._unknown23}
    set {_uniqueStorage()._unknown23 = newValue}
  }
...
///21
struct BilibiliDm_Community_Service_Dm_Live_Room {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///14-1
struct BilibiliDm_Community_Service_Dm_Live_emots {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///14-2
struct BilibiliDm_Community_Service_Dm_Live_Emoticon {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///17
struct BilibiliDm_Community_Service_Dm_Live_Aggregation {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///20-14
struct BilibiliDm_Community_Service_Dm_Live_Identify {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///20-13
struct BilibiliDm_Community_Service_Dm_Live_Title {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///20-15
struct BilibiliDm_Community_Service_Dm_Live_Wealth {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct BilibiliDm_Community_Service_Dm_Live_Prefix {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BilibiliDm_Community_Service_Dm_Live_BizScene: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_DmType: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Dm: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Check: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Room: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Bubble: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_emots: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Emoticon: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Voice: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Aggregation: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_User: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Identify: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Medal: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_UserLevel: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Title: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Record: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Wealth: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Icon: @unchecked Sendable {}
extension BilibiliDm_Community_Service_Dm_Live_Prefix: @unchecked Sendable {}
...
extension BilibiliDm_Community_Service_Dm_Live_Dm: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _emoticons: [BilibiliDm_Community_Service_Dm_Live_emots] = []
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 23: try { try decoder.decodeSingularBytesField(value: &_storage._unknown23) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._unknown23.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._unknown23, fieldNumber: 23)
      }
  ...
  static func ==(lhs: BilibiliDm_Community_Service_Dm_Live_Dm, rhs: BilibiliDm_Community_Service_Dm_Live_Dm) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._unknown23 != rhs_storage._unknown23 {return false}
...
extension BilibiliDm_Community_Service_Dm_Live_emots: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".emots"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
    2: .same(proto: "value"),
  ]
  ...
  static func ==(lhs: BilibiliDm_Community_Service_Dm_Live_emots, rhs: BilibiliDm_Community_Service_Dm_Live_emots) -> Bool {
...
extension BilibiliDm_Community_Service_Dm_Live_Title: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.title1) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.title1.isEmpty {
      try visitor.visitSingularStringField(value: self.title1, fieldNumber: 1)
    }
  ...
  static func ==(lhs: BilibiliDm_Community_Service_Dm_Live_Title, rhs: BilibiliDm_Community_Service_Dm_Live_Title) -> Bool {
    if lhs.title1 != rhs.title1 {return false}
